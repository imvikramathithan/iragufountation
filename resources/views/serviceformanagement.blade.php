...
<!-- School Setting -->
    <div class="sfm">
        <div class="sus sfm-top">
            <h1 class="display text-center sfm-color">Service for Management</h1>
            <hr> 
       ...
       <div class="cas sfm-main " id="curriculam">
        ...
        <div class="std sfm-main " id="studio">
            <div class="container" >
                <div class="sr-row ">
                    <div class="sr-col"> <p class="qoutes">"The field of creativity that exists within each individual is freed by moving out of ideas of wrongdoing or right doing."</p>
