...
class MailController extends Controller
{
    public function sendContactMail(Request $request){
        ...
        Mail::to('dctteamscolab@gmail.com')->send(new ContactFormMail($contact_data));
    ...
    public function sendManagementMail(Request $request){
        ...
        Mail::to('dctteamscolab@gmail.com')->send(new ManagementFormMail($management_data));
    ...
    public function sendDonationMail(Request $request){
        ...
        Mail::to('dctteamscolab@gmail.com')->send(new DonationFormMail($donation_data));
